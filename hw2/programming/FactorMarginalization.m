...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Since we can not say the input A.val is in row format,
% I initialize it such that having the same format as input.
size_A_val = size(A.val);
if size_A_val(1) > size_A_val(2)
