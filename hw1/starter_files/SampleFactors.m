...
%
%   phi = struct('var', [3 1 2], 'card', [2 2 2], 'val', ones(8, 1));
%
...
%
% A factor's values are stored in a column vector in the .val field 
...
% assignments to the index of the column vector in the .val field:
%
% -+-----+-----+-----+-------------------+   
