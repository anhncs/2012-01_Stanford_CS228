...
% Separated by part
  srcs = { { 'EM_cluster.m', 'partner.txt' }, ... %1
	   { 'EM_HMM.m', 'partner.txt' }, ... %3    
	   { 'RecognizeActions.m', 'partner.txt' }, ... %5
	   { 'RecognizeUnknownActions.m', 'YourMethod.txt', 'partner.txt' } %7
	 };
end
