...
% Separated by part
  srcs = { { 'SimpleCalcExpectedUtility.m', 'partner.txt' }, ...
	   { 'CalculateExpectedUtilityFactor.m', 'partner.txt' }, ...     
	   { 'OptimizeMEU.m', 'partner.txt' }, ...
	   { 'OptimizeWithJointUtility.m', 'partner.txt' }, ...
	   { 'OptimizeLinearExpectations.m', 'partner.txt' }
	 };
end
