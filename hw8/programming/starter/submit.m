...
% Separated by part
  srcs = { { 'FitGaussianParameters.m', 'partner.txt' }, ... %1
	   { 'FitLinearGaussianParameters.m', 'partner.txt' }, ... %3    
	   { 'ComputeLoglikelihood.m', 'partner.txt' }, ... %5
	   { 'LearnCPDsGivenGraph.m', 'partner.txt' }, ... %7     
	   { 'ClassifyDataset.m', 'partner.txt' }, ... %9
	   { 'LearnGraphStructure.m', 'partner.txt' }, ... %11
	   { 'LearnGraphAndCPDs.m', 'partner.txt' } %13
	 };
end
